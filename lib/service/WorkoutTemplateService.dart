...
class WorkoutTemplateService {
  static const String baseUrl = 'https://kumbubackend.onrender.com/api/workoutTemplates';
  ...
  Future<void> assignWorkoutTemplate(String memberId, String workoutTemplateId) async {
    final response = await http.post(
      Uri.parse('https://kumbubackend.onrender.com/api/memberWorkoutTemplate/assign'),
